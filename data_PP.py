...
def move_images_with_filter(source_dir, target_dir, filter_cond='CAM'):
    ...
    for split_dir, split_file in zip(split_dirs, split_files):
        ...
        with open(split_file, 'r') as f:
            for line in f:
                ...
                shutil.move(os.path.join(datadir, file_name), split_dir)
...
def main(args):
    ...
    move_images_with_filter(os.path.join(args.dataroot, 'samples'), args.images_dir)
